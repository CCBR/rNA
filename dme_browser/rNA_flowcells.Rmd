...
params:
  raw: "RSEM_genes_expected_counts.tsv"
  tin: "combined_TIN.tsv"
  qc: "multiqc_matrix.tsv"
  wdir: "."
  annot: "FALSE"
output:
...
g <- ggplot(multiQC, aes(PC1, PC2, color = flowcell_lanes), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = percent_duplication), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = percent_aligned), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = pct_utr_bases), xlab) + geom_point(size = 2) + theme_minimal() +
...
```{r colored-by-intronic-bases}
# Gene Expression PCA colored by % Intronic
g <- ggplot(multiQC, aes(PC1, PC2, color = pct_intronic_bases), xlab) + geom_point(size = 2) + theme_minimal() +
        labs(color = "% Intronic", x = paste0("PC1 (",pc1,"%)"), y = paste0("PC2 (",pc2,"%)")) +
          scale_colour_gradientn(colours = viridis::viridis(100))
...
g <- ggplot(multiQC, aes(PC1, PC2, color = inner_distance_maxima), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = median_cv_coverage), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = median_3prime_bias), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = median_insert_size), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = gc_content), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = median_tin), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = pct_coding_bases), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = rRNA_percent_aligned), xlab) + geom_point(size = 2) + theme_minimal() +
...
g <- ggplot(multiQC, aes(PC1, PC2, color = percent_antisense_strand), xlab) + geom_point(size = 2) + theme_minimal() +
